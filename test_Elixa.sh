...
java -jar target/elixa-$VERSION.jar tag-doc -f tabNotagged -cn 3 -l en < src/main/resources/examples/example_en.tsv 
java -jar target/elixa-$VERSION.jar tag-doc -f tabNotagged -cn 3 -l fr < src/main/resources/examples/example_fr.tsv 
java -jar target/elixa-$VERSION.jar tag-doc -f tabNotagged -cn 3 -l eu < src/main/resources/examples/example_eu.tsv 
java -jar target/elixa-$VERSION.jar tag-doc -f tabNotagged -cn 3 -l es < src/main/resources/examples/example_es.tsv 
