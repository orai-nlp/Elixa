...
import eus.ixa.ixa.pipe.tok.*;
/*import eus.ixa.ixa.pipe.tok.Normalizer;
import eus.ixa.ixa.pipe.tok.tokenFactory;*/
/**
 * This class provides a multilingual rule based tokenizer for Twitter. The
 ...
 * 
 */
public class TwitterRBTokenizer implements Tokenizer {
   ...
   *          the options
   */
  public TwitterRBTokenizer(final String text, final Properties properties) {
